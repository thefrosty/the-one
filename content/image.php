<article <?php hybrid_attr( 'post' ); ?>>
	...
	<?php if ( is_singular( get_post_type() ) ) : // If viewing a single post. ?>
		...
		<footer class="entry-footer">
			<?php hybrid_post_terms( array( 'taxonomy' => 'category', 'text' => esc_html__( 'Posted in %s', 'the-one' ) ) ); ?>
			<?php hybrid_post_terms( array( 'taxonomy' => 'post_tag', 'text' => esc_html__( 'Tagged %s', 'the-one' ), 'before' => '<br />' ) ); ?>
		</footer><!-- .entry-footer -->
